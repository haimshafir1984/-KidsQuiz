...
export default function Header() {
  ...
  const links = [
    { label: 'מסלולי לימוד 📚', path: '/age' },
    { label: 'אזור אישי 👤', path: '/admin', adminOnly: true },
  ]
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              ...
              <div className="hidden text-sm text-slate-600 sm:block">תרגול חכם, צבעוני ומלא מוטיבציה</div>
            </div>
          </button>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden text-right lg:block">
              ...
              <div className="text-xs text-slate-600">{user.role === 'admin' ? 'מנהל מערכת' : 'לומד פעיל'}</div>
            </div>

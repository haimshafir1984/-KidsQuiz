...
export const SUBJECT_CATALOG = {
  ...
  'thinking-challenge': [
    ...
    {
      label: 'אתגר מחשבתי: השלמת צורות',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
      tone: 'bg-orange-50 text-orange-600',
      hover: 'hover:border-orange-300',
      emoji: '🧩',
    ...
    {
      label: 'אתגר מחשבתי: מתמטיקה - שאלות היגיון',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
    ...
    {
      label: 'אתגר מחשבתי: מתמטיקה - סדרות מספרים',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
    ...
    {
      label: 'אתגר מחשבתי: מתמטיקה - ידע כמותי',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
    ...
    {
      label: 'אתגר מחשבתי: ראייה מרחבית',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
    ...
    {
      label: 'אתגר מחשבתי: השוואה בין מחרוזות',
      aliases: [],
      questionTypes: 'סגורות',
      levels: ['רמה 1', 'רמה 2', 'רמה 3'],
      activities: ['practice'],
